  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <CustomHero
        ...
        title="Email campaigns that"
        titleHighlight="people actually read"
        description="We create email marketing campaigns that build relationships, drive engagement, and generate real business results. No spam, just value."
        primaryCTA={{
          text: "Get started",
          href: "/contact",
        }}
