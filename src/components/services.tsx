...
import { ChartNoAxesCombined, Images, Mail, Paintbrush, Paintbrush2, Target, Terminal } from 'lucide-react'
            ...
            <div className={cn("py-24", className)}>
                <div className="mx-auto max-w-6xl px-6">
                    <div className='text-center'>
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">Full Stack Digital Solutions
</h2>
                        <p className="text-muted-foreground mt-3 text-lg">From brand awareness to final scale, we cover it all.
...
const ServicesCard = ({ title, description, children, link = 'https://github.com/meschacirung/cnblocks' }: { title: string; description: string; children: React.ReactNode; link?: string }) => {
    return (
        <Card
            className="p-6 border-none bg-zinc-50">
